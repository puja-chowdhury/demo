...
WebUI.click(findTestObject('Page_CURA Healthcare Service/select_Tokyo CURA Healthcare Center        _5b4107'))

WebUI.check(findTestObject('Page_CURA Healthcare Service/label_Apply for hospital readmission'))
...
WebUI.setText(findTestObject('Page_CURA Healthcare Service/textarea_Comment_comment'), 'enquiry')
